                            ...
                            <div class="simplecheckout-block" id="simplecheckout_customer">
                                ...
                                <textarea class="form-control" name="comment" id="comment" placeholder="Необязательно*" data-reload-payment-form="true"></textarea>
                                            ...
                                            <div class="personal-data-consent">
                                                ...
                                                <details class="personal-data-consent__details">
                                                    <summary>Обработка персональных данных</summary>
                                                    <div class="personal-data-consent__text">
                                                        <p>Настоящим я подтверждаю, что свободно, своей волей и в своем интересе даю согласие на обработку предоставленных мной персональных данных, включая фамилию, имя, отчество, номер телефона, адрес электронной почты, адрес доставки и иную информацию, указанную при оформлении заказа.</p>
                                                        <p>Согласие предоставляется для оформления и обработки заказа, связи со мной по вопросам заказа, доставки товаров, исполнения договорных обязательств, ведения учета обращений и соблюдения требований законодательства.</p>
                                                        <p>Обработка персональных данных может включать сбор, систематизацию, хранение, уточнение, использование, передачу службам доставки и иным лицам, участвующим в исполнении заказа, а также удаление или уничтожение данных после достижения целей обработки либо при отзыве согласия.</p>
                                                        <p>Я уведомлен(а), что могу отозвать согласие на обработку персональных данных путем направления письменного обращения владельцу сайта. Отзыв согласия не влияет на законность обработки, осуществленной до момента его получения.</p>
                                                    </div>
                                                </details>
                                            </div>    
